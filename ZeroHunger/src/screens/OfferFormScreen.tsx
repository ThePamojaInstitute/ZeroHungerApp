        ...
        <ScrollView testID="Offer.formContainer" style={styles.formContainer}>
            ...
            {loaded &&
                ...
                <DatePicker />
                    ...
                    <View>
                        <Text testID="Request.dateLabel" style={styles.formTitleText}>{t("offer.form.fields.6.label")}</Text>
                        <Text testID="Request.dateDesc" style={styles.formDescText}>{t("offer.form.fields.6.label")}</Text>
                        <Logistics logistics={logistics} setLogistics={setLogistics} />
                    </View>
                    <View>
                        <Text testID="Request.dateLabel" style={[styles.formTitleText, { color: postalErr ? Colors.alert2 : Colors.dark }]}>{t("offer.form.fields.7.label")}</Text>
                        <Text testID="Request.dateDesc" style={styles.formDescText}>{t("offer.form.fields.7.desc")}</Text>
                    ...
                    <View>
                        <Text testID="Request.dateLabel" style={styles.formTitleText}>{t("offer.form.fields.8.label")}</Text>
                        <Text testID="Request.dateDesc" style={styles.formDescText}>{t("offer.form.fields.8.desc")}</Text>
