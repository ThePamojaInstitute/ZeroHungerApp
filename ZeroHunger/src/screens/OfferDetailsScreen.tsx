...
export const RequestDetailsScreen = () => {
    ...
    return (
        <View style={{flex: 1}}>
            ...
            <Text style={styles.headerText}>Need this item? Send {route.params.postedBy} a message.</Text>
            <View style={styles.messageInputView}>
                <TextInput
                    placeholder={"Hi " + route.params.postedBy + ", I need " + route.params.title + ", would you like to meet?"}
