...
urlpatterns = [
    ...
    path('getNotificationsSettings', getNotificationsSettings.as_view()),
    path('updateNotificationsSettings', updateNotificationsSettings.as_view()),
    ...
    path('getPublicKeys', getPublicKeys.as_view())
]
